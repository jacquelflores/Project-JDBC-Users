...
import org.example.interfaces.UsuarioRepo;
import org.example.interfaces.UsuarioRepositorioImpl;
...
public class UsuarioPrincipal {
    public static void main(String[] args) {
        ...
        try (Connection conn = ConexionBD.getInstance()) {
            UsuarioRepo<Usuario> repositorio = new UsuarioRepositorioImpl();
            int opcionIndice = 0;
            do {
                ...
                if (opcion == null) {
                    ...
                    switch (opcionIndice) {
                        case 1: {
                            id = Integer.valueOf(JOptionPane.showInputDialog(null, "Ingresar el id del usuario para Actualizar:"));
